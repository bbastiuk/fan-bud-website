...
const i18n = {
  pl: {
    ...
    'about.desc':         'FAN-BUD to doświadczony zespół specjalistów z\u00a0Poznania. Realizujemy projekty od fundamentów po kompleksowe wyburzenia — zawsze z\u00a0pełnym zaangażowaniem i\u00a0odpowiedzialnością za każdy detal.',
    ...
    'footer.desc':        'Budowa lub\u00a0rozbiórka obiektów w\u00a0Poznaniu i\u00a0Wielkopolsce. Generalne wykonawstwo dla\u00a0wymagających inwestorów.',
  ...
  ua: {
    ...
    'about.desc':         'FAN-BUD — це досвідчена команда фахівців з Познані. Реалізуємо проєкти від фундаменту до комплексного знесення — завжди з повною відданістю та відповідальністю за кожну деталь.',
    ...
    'footer.desc':        'Будівництво або знесення об\'єктів у Познані та Великопольщі. Генеральний підряд для вимогливих інвесторів.',
