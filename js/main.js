...
const i18n = {
  pl: {
    ...
    'about.desc':         'FAN-BUD (znana również jako Fan Bud lub Fanbud) to doświadczony zespół specjalistów z\u00a0Poznania. Realizujemy projekty od fundamentów po kompleksowe wyburzenia — zawsze z\u00a0pełnym zaangażowaniem i\u00a0odpowiedzialnością za każdy detal.',
    ...
    'footer.desc':        'FAN-BUD (Fan Bud, Fanbud) — budowa lub\u00a0rozbiórka obiektów w\u00a0Poznaniu i\u00a0Wielkopolsce. Generalne wykonawstwo dla\u00a0wymagających inwestorów.',
  ...
  ua: {
    ...
    'about.desc':         'FAN-BUD (також відома як Fan Bud або Fanbud) — це досвідчена команда фахівців з Познані. Реалізуємо проєкти від фундаменту до комплексного знесення — завжди з повною відданістю та відповідальністю за кожну деталь.',
    ...
    'footer.desc':        'FAN-BUD (Fan Bud, Fanbud) — будівництво або знесення об\'єктів у Познані та Великопольщі. Генеральний підряд для вимогливих інвесторів.',
